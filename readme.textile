  ...
  <div class="navbar-inner">
    <div class="container">
      <ul class="nav">
        ...
        <li><a href="#lzf-compression">LZF</a></li>
      </ul>
    </div>
  </div>
</div>
...
First decode the ziplist as a string as specified in the "string":#string section above. Then continue parsing the decoded ziplist as follows:
...
First decode the intset as a string as specified in the "string":#string section above. Then continue parsing the decoded intset as follows:
...
First decode the zipmap as a string as specified in the "string":#string section above. Then continue parsing the decoded string as follows:
...
# Fetch another byte and combine it with the "high distance." (Shift the high distance left 8 bits and OR the two). This new value is the "distance"
# Now go to the [distance] to last char in the decoded string and copy [length]+2 characters. If length is longer than the remaining characters in the decoded string, loop back to the beginning of distance and continue copying.
## For instance. If you have decoded "foobar" so far, your distance is 1 and your length+2 is 10, you would repeat "ar" five times, totalling 10 characters.
# Repeat this algorithm until you have reached the end of the compressed string.
